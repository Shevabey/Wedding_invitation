...
const util = (() => {
    ...
    const timer = () => {
        // Set tanggal dan waktu yang diinginkan (20 Januari 2024 pukul 09:00:00)
        let countDownDate = new Date('2024-01-20T09:00:00').getTime();
    ...
    const buka = async (button) => {
        ...
        // Mengubah posisi halaman ke bagian home tanpa animasi scroll
...
// Agar tidak ke app scrip google sheet
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(e) {
      ...
      if (jumlah < 1 || jumlah > 5) {
        alert("Jumlah harus di antara 1 dan 5");
        return;
      }
  
      if (status !== 'Hadir' && status !== 'Berhalangan') {
        alert("Pilih opsi yang valid untuk kehadiran");
        return;
      }
      ...
      .then(() => {
        ...
        // Membersihkan nilai input setelah alert ditutup
  ...
  /**
    ...
    */
    (function() { // DON'T EDIT BELOW THIS LINE
        ...
        s.src = 'https://fulan-wedding-4.disqus.com/embed.js';
